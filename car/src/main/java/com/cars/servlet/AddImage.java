...
public class AddImage extends HttpServlet {
    ...
    // Permanent upload folder (change as needed)
    private static final String BASE_UPLOAD_DIR = "C:/Users/acer/eclipse-workspace/car/src/main/webapp/uploads/profileImages/";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String relativePath = "uploads/profileImages/" + uniqueFileName;

        try {
        	 System.out.println("Uploading image for user: " + user.getEmail());
             System.out.println("Relative image path: " + relativePath);
             
            UserDAO userDAO = new UserDAO();
            userDAO.updateUserImage(user.getEmail(), relativePath);
